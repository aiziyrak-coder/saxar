...
import { Wallet, ArrowDownRight, History, CheckCircle2, AlertCircle } from 'lucide-react';
    ...
    <div className="space-y-6">
      ...
      <Card className="bg-gradient-to-br from-emerald-50 to-emerald-100 text-slate-900 border-none shadow-lg">
        <div className="flex justify-between items-center mb-4">
          <h2 className="font-bold text-slate-900">Mening kassam (Naqd)</h2>
          <Wallet className="h-5 w-5 text-emerald-600" />
        </div>
        <div className="text-3xl font-bold mb-1">4,000,000 <span className="text-lg font-normal text-emerald-200">UZS</span></div>
        <div className="text-sm text-emerald-700 flex items-center gap-1 mt-2">
          <AlertCircle className="h-4 w-4" /> Buxgalteriyaga topshirilmagan
        </div>
      </Card>
